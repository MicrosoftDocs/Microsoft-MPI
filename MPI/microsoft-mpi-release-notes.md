...
## MS-MPI v10.1 (September 2019)
MS-MPI v10.1 includes the following improvements and fixes. Download MS-MPI v10.1 from the [Microsoft Download Center](https://www.microsoft.com/download/details.aspx?id=100299).
...
The MS-MPI v10.1 SDK is also available on [nuget](https://www.nuget.org/packages/msmpisdk/).
